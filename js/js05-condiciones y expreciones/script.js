console.log("JS05: Condiciones y expreciones");
...
let dinero = 2 * 3 / 3 ; //2 (izquierda)
console.log("Potencia", 2**3); // 8 (Derecha)
console.log("Potencia", 2**3**2); // 512 (Derecha)
...
const cuentaBancaria = +dinero; //-10 <=== + No cambia el signo
console.log(dinero);

let cambio = +"100"; // Number("100");
